...
module VisibleEncounterSettings
  ...
  DEFAULT_STEPS_BEFORE_VANISH = 8 # default 10
...
#===============================================================================
# defining new method pbPlacePokeBall to add/place and visualise the Pokaball
# on the overworld-tile (x,y)
#===============================================================================
def pbPlacePokeBall()
  hasPokeBall = $bag.has?(:POKEBALL)
  if !$map_factory
    x = $game_player.x
    y = $game_player.y
    $game_map.spawnPokeBall(x,y)
  else
    mapId = $game_map.map_id
    spawnMap = $map_factory.getMap(mapId)
    spawnMap.spawnPokeBall(x,y)
  end
end
...
#     event.y = y
#     #--- Graphic of the event -----------------------------------------
#     #ballType = [pokemon.species,pokemon.level]
#     #event.pages[0].graphic.tile_id = 0

#     event.pages[0].graphic.character_name = "Graphics/Characters/Object ball.png"
#     #--- movement of the event --------------------------------
...
#     event.pages[0].trigger = 2
#     event.pages[0].always_on_top = true
...
#===============================================================================
def pbPlayCryOnOverworld(pokemon,form=0,volume=20,pitch=95) # default volume=30
